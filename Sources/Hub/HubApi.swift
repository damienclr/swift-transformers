...
public struct HubApi {
    ...
    // URL de base du bucket Cloudflare R2
    private static let cloudflareR2URL = "https://appcaptainshot.frenchpavillon.com"
    private static let modelId = "mlx-community/Llama-3.2-3B-Instruct-4bit"
